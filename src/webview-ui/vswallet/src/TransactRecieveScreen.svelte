...
<!-- Recieve ETH ui steps:
  show QR code for wallet addr/maybve other data idk
  show wallet addr as text
-->
<main>
  <h1 class="screen-title">Recieve ETH</h1>

  <div class="eth-addr-qr">
    <p>*qr code here*</p>
  </div>

  <div class="eth-addr-text">
    <button class="copy-eth-addr-button" title="copy-eth-addr-button">
  ...
  <button on:click={() => onNavigate("HomeScreen")}>Home</button>
</main>
