...
console.log('🔑 API Key loaded:', process.env.ETHERSCAN_API_KEY ? 'YES ✓' : 'NO ✗');
console.log('🔑 First 5 chars:', process.env.ETHERSCAN_API_KEY?.substring(0, 5) || 'MISSING');
console.log('');
...
async function testWallet() {
  ...
  try {
    ...
    console.log('⚠️  SAVE THESE - They won\'t be stored!\n');
